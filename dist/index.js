...
class User {
    ...
    buyCourse(course) {
        const courseFind = this.purchasedCourses.find((item) => item.toLocaleLowerCase() == course.toLocaleLowerCase());
        if (!courseFind) {
...
class CourseManager {
    ...
    listCourses(numOfStudents) {
        this.courses.map((item) => console.log(`
                ${item.displayCourse}
...
do {
    ...
    switch (choice) {
        ...
        case 7:
            ...
            break;
        case 8:
            console.log("Tổng doanh thu: " + courseManagers.calculateTotalRevenue() + " VND");
            break;
        case 9:
